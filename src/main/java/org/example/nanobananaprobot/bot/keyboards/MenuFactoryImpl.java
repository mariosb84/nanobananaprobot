...
public class MenuFactoryImpl implements MenuFactory {
    ...
    public SendMessage createPromptsExamplesMenu(Long chatId) {
        ...
        /* Отправляем первый пример с картинкой*/
        String caption1 = "🚁 *Пример: Фото с вертолётом*\n\n" +
                "```\n" +
        ...
        telegramService.sendPromptExample(chatId, "helicopter.jpg", caption1);

        /* Отправляем второй пример*/
        String caption2 = "🏞️ *Пример: Горное озеро*\n\n" +
                "```\n" +
        ...
        telegramService.sendPromptExample(chatId, "lake.jpg", caption2);

        /* Отправляем третий пример*/
        String caption3 = "🎭 *Пример: Киберпанк портрет*\n\n" +
                "```\n" +
        ...
        telegramService.sendPromptExample(chatId, "cyberpunk.jpg", caption3);

        /* Отправляем четвёртый пример*/
        String caption4 = "🍕 *Пример: Предметная съёмка*\n\n" +
                "```\n" +
        ...
        telegramService.sendPromptExample(chatId, "pizza.jpg", caption4);

        /* Отправляем пятый пример*/
        String caption5 = "🐱 *Животные в стиле фэнтези:*\n\n" +
                "```\n" +
        ...
        telegramService.sendPromptExample(chatId, "fantazyAnimal.jpg", caption5);

        /* Отправляем шестой пример*/
        String caption6 = "🏛️ *Архитектура в стиле модерн:*\n\n" +
                "```\n" +
        ...
        telegramService.sendPromptExample(chatId, "modern.jpg", caption6);

        /* Отправляем седьмой пример*/
        String caption7 = "🎨 *Абстракция для фона:*\n\n" +
                "```\n" +
        ...
        telegramService.sendPromptExample(chatId, "fonAbstraction.jpg", caption7);

        /* Отправляем советы*/
        String caption8 = "💡 *Советы:*\n\n" +
        ...
        telegramService.sendPromptExample(chatId, "advice.jpg", caption8);

        /* В конце отправляем сообщение с кнопкой назад*/
        SendMessage message = new SendMessage();
        message.setChatId(chatId.toString());
